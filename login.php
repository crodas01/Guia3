	...
	<div id="contenedor">
		...
		<header>
			...
			<div style="width: 100%" align="center">
				<form class="contact_form" action="login2.php" id="login_form" method="post">
					<div align="center" style="padding-top: 80px; padding-left: 80px">
						<ul> 
							<li><a id="INICIO_SESION"><h2>INICIO DE SESION</h2></a></li> 
							<li> 
								<label for="usu">Nombre de Usuario:</label> 
								<input type="text" id="usuLogin" name="usuLogin" placeholder="Nombre de Usuario" required /> 
							</li> 
							<li> 
								<label for="passw">Password:</label> 
								<input type="password" id="passwLogin" name="passwLogin" placeholder="Password" required /> 
							</li> 
							<li> 
								<button class="submit" type="submit" id="login" name="login">Iniciar Sesion</button> 
							</li> 
						</ul> 
					</div> 
				</form>
